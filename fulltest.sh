...
do
 ...
 CUDA_VISIBLE_DEVICES=0 python ./examples/backdoor_defense.py --verbose 1 --validate_interval 1 --dataset cifar10 --model resnet18_comp --attack prob --defense neural_cleanse --random_init --device cuda --save >> defense_nc_attack_prob_cifar_multirun2.txt
...
CUDA_VISIBLE_DEVICES=0 python ./examples/backdoor_attack.py --verbose 1 --dataset cifar10 --model resnet18_comp --attack badnet --device cuda --epoch 200 --save --mark_path square_white.png  --mark_height 3  --mark_width 3  --height_offset 2  --width_offset 2  --batch_size 100 --pretrain >> attack_badnet_cifar_multirun2.txt
 ...
 CUDA_VISIBLE_DEVICES=0 python ./examples/backdoor_defense.py --verbose 1 --validate_interval 1 --dataset cifar10 --model resnet18_comp --attack badnet --defense neural_cleanse --random_init --device cuda --save >> defense_nc_attack_badnet_cifar_multirun2.txt
#######
#mnist
#######
 ...
 CUDA_VISIBLE_DEVICES=0 python ./examples/backdoor_defense.py --verbose 1 --validate_interval 1 --dataset mnist --model net --attack prob --defense neural_cleanse --random_init --device cuda --save >> defense_nc_attack_prob_mnist_multirun2.txt
...
CUDA_VISIBLE_DEVICES=0 python ./examples/backdoor_attack.py --verbose 1 --dataset mnist --model net --attack badnet --device cuda --epoch 200 --save --mark_path square_white.png  --mark_height 3  --mark_width 3  --height_offset 2  --width_offset 2  --batch_size 100 >> attack_badnet_mnist_multirun2.txt 
 ...
 CUDA_VISIBLE_DEVICES=0 python ./examples/backdoor_defense.py --verbose 1 --validate_interval 1 --dataset mnist --model net --attack badnet --defense neural_cleanse --random_init --device cuda --save >> defense_nc_attack_badnet_mnist_multirun2.txt
